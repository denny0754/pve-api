...
module.exPosts = function (uname, pwd, realm, host, verboseLevel) {
    ...
    const _logger = winston.createLogger({
        ...
        transPosts: [new winston.transPosts.Console({
            level: _loggerLevel,
                        ...
                        Qemu: {
                            ...
                            Cpu: {
                                Get: async function () {
                                    await _GenerateNewTicket();
                                    _pveNodesApi._SetTicket(_pveTicket);
                                    return await _pveNodesApi.Node(node).Capabilities.Qemu.Cpu.Get();
                                }
                            },
                            Machines: {
                                Get: async function () {
                                    await _GenerateNewTicket();
                                    _pveNodesApi._SetTicket(_pveTicket);
                                    return await _pveNodesApi.Node(node).Capabilities.Qemu.Machines.Get();
                                }
                            }
                        }
                    },
                            ...
                            Name: function (name) {
                                return {
                                    Post: async function (params) {
                                        await _GenerateNewTicket();
                                        _pveNodesApi._SetTicket(_pveTicket);
                                        return await _pveNodesApi.Node(node).Ceph.Fs.Name(name).Post(params);
                                    }
                                }
                            }
                        },
                            ...
                            Name: function (name) {
                                return {
                                    Post: async function (params) {
                                        await _GenerateNewTicket();
                                        _pveNodesApi._SetTicket(_pveTicket);
                                        return await _pveNodesApi.Node(node).Ceph.Mds.Name(name).Post(params);
                                    },

                                    Delete: async function (params) {
                                        await _GenerateNewTicket();
                                        _pveNodesApi._SetTicket(_pveTicket);
                                        return await _pveNodesApi.Node(node).Ceph.Mds.Name(name).Delete(params);
                                    }
                                }
                            }
                        },
                            ...
                            Id: function (id) {
                                return {
                                    Post: async function (params) {
                                        await _GenerateNewTicket();
                                        _pveNodesApi._SetTicket(_pveTicket);
                                        return await _pveNodesApi.Node(node).Ceph.Mgr.Id(id).Post(params);
                                    },

                                    Delete: async function (params) {
                                        await _GenerateNewTicket();
                                        _pveNodesApi._SetTicket(_pveTicket);
                                        return await _pveNodesApi.Node(node).Ceph.Mgr.Id(id).Delete(params);
                                    }
                                }
                            }
                        },
                            ...
                            MonID: function (monid) {
                                return {
                                    Post: async function (params) {
                                        await _GenerateNewTicket();
                                        _pveNodesApi._SetTicket(_pveTicket);
                                        return await _pveNodesApi.Node(node).Ceph.Mon.MonID(monid).Post(params);
                                    },

                                    Delete: async function (params) {
                                        await _GenerateNewTicket();
                                        _pveNodesApi._SetTicket(_pveTicket);
                                        return await _pveNodesApi.Node(node).Ceph.Mon.MonID(monid).Delete(params);
                                    }
                                }
                            }
                        },
