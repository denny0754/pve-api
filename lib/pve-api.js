...
const pve_utils = require('./pve-utils/pve-curl')();
...
module.exports = function (uname, pwd, realm, host) {
    ...
    let _GenerateNewTicket = async () => {
        if (_pveTicket.timeStamp + 7200 < new Date().getTime()) {
            ...
            var header = {};
            var response = await pve_utils.PveCurl.Post('/access/ticket', _pveAuthInfo, _pveTicket, body, header);
    ...
    let Module = {
        ...
        Version: {
            Post: async function () {
                ...
                var body = {};
                var header = {};
                return await pve_utils.PveCurl.Post('/version', _pveAuthInfo, _pveTicket, body, header);
            }
        },
    };
