    ...
    let Module = {
        ...
        PveCurl: {
            ...
            Get: async function (reqUrl, reqBody, reqHeader, reqCookie) {
                return await _MakeRequest(reqUrl, REQUEST_TYPE.GET, reqBody, reqHeader, reqCookie);
            },

            Post: async function (reqUrl, reqBody, reqHeader, reqCookie) {
                return await _MakeRequest(reqUrl, REQUEST_TYPE.POST, reqBody, reqHeader, reqCookie);
            },

            Put: async function (reqUrl, reqBody, reqHeader, reqCookie) {
                return await _MakeRequest(reqUrl, REQUEST_TYPE.PUT, reqBody, reqHeader, reqCookie);
            },

            Delete: async function (reqUrl, reqBody, reqHeader, reqCookie) {
                return await _MakeRequest(reqUrl, REQUEST_TYPE.DELETE, reqBody, reqHeader, reqCookie);
            }
        }
    };
